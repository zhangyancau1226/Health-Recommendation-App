...
export default class PhoenixScreen extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            isMount: false,
    ...
    async goToFood(i){
        ...
        console.log(name.split(" ")[0]+"PX");
            this.props.navigation.navigate(name.split(" ")[0]+"PX");

    }

    changeLoop() {
        var pictures = [<Image style = {styles.restaurantimg} source={require("../assets/images/phoenix0.png")}/>,
        <Image style = {styles.restaurantimg} source={require("../assets/images/phoenix1.jpg")}/>,
